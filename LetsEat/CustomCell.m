...
- (void)awakeFromNib {
    ...
    //Configurar labels
    self.labelName.font = [UIFont fontWithName:@"Dosis-Bold" size:24];
    self.labelType.font = [UIFont fontWithName:@"Dosis-SemiBold" size:14];
    self.labelHour.font = [UIFont fontWithName:@"Dosis-Medium" size:12];
    self.labelTables.font = [UIFont fontWithName:@"Dosis-SemiBold" size:16];
    self.labelNumberTables.font = [UIFont fontWithName:@"Dosis-Medium" size:14];
    self.labelDesc.font = [UIFont fontWithName:@"Dosis-SemiBold" size:16];
    self.labelInfoDesc.font = [UIFont fontWithName:@"Dosis-Medium" size:14];
