...
#import "BaseSignInResponseDTO.h"

@implementation BaseSignInResponseDTO

#pragma mark - NSCopying
// Creates a non-mutable copy of this DTO Object
-(id)copyWithZone:(NSZone *)zone {

	BaseSignInResponseDTO *copy=[[[self class] alloc] init];
    if(copy) {
...
- (BOOL)isEqual:(id)anObject {
	...
	if (![anObject isKindOfClass:[BaseSignInResponseDTO class]]) {
		return NO;
	}
	return [self isEqualToBaseSignInResponseDTO:(BaseSignInResponseDTO *)anObject];
}
