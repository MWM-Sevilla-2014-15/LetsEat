...
#import "BaseGetPassResponseDTO.h"

@implementation BaseGetPassResponseDTO

#pragma mark - NSCopying
// Creates a non-mutable copy of this DTO Object
-(id)copyWithZone:(NSZone *)zone {

	BaseGetPassResponseDTO *copy=[[[self class] alloc] init];
    if(copy) {
...
- (BOOL)isEqual:(id)anObject {
	...
	if (![anObject isKindOfClass:[BaseGetPassResponseDTO class]]) {
		return NO;
	}
	return [self isEqualToBaseGetPassResponseDTO:(BaseGetPassResponseDTO *)anObject];
}
