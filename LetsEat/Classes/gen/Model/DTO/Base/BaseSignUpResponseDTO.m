...
#import "BaseSignUpResponseDTO.h"

@implementation BaseSignUpResponseDTO

#pragma mark - NSCopying
// Creates a non-mutable copy of this DTO Object
-(id)copyWithZone:(NSZone *)zone {

	BaseSignUpResponseDTO *copy=[[[self class] alloc] init];
    if(copy) {
...
- (BOOL)isEqual:(id)anObject {
	...
	if (![anObject isKindOfClass:[BaseSignUpResponseDTO class]]) {
		return NO;
	}
	return [self isEqualToBaseSignUpResponseDTO:(BaseSignUpResponseDTO *)anObject];
}
