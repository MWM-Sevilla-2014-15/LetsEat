...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if([[buttonTitles objectAtIndex:i] isEqualToString:@"CANCELAR"]){
            ...
            [closeButton setTitleColor:[UIColor colorWithRed:132.0/255.0 green:132.0/255.0 blue:132.0/255.0 alpha:1.0] forState:UIControlStateNormal];
            [closeButton setTitleColor:[UIColor colorWithRed:132.0/255.0 green:132.0/255.0 blue:132.0/255.0 alpha:0.5] forState:UIControlStateHighlighted];
            ...
            [closeButton setTitle:[buttonTitles objectAtIndex:i] forState:UIControlStateNormal];
            [closeButton setTitleColor:[UIColor colorWithRed:73.0/255.0 green:190.0/255.0 blue:197.0/255.0 alpha:1.0] forState:UIControlStateNormal];
            [closeButton setTitleColor:[UIColor colorWithRed:73.0/255.0 green:190.0/255.0 blue:197.0/255.0 alpha:0.5] forState:UIControlStateHighlighted];
            [closeButton.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:15]];
            [closeButton.layer setCornerRadius:kCustomIOSAlertViewCornerRadius];
